...
namespace DomeTrainEntityFramework.Migrations
{
    ...
    [Migration("20260525145557_ChangedToInternetRating")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DomeTrainEntityFramework.Models.Genre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomeTrainEntityFramework.Models.Movie", b =>
                {
            ...
            modelBuilder.Entity("DomeTrainEntityFramework.Models.Movie", b =>
                {
                    b.HasOne("DomeTrainEntityFramework.Models.Genre", "Genre")
                        .WithMany("Movies")
                        .HasForeignKey("MainGenreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsMany("DomeTrainEntityFramework.Models.Person", "Actors", b1 =>
                        {
                    ...
                    b.OwnsOne("DomeTrainEntityFramework.Models.Person", "Director", b1 =>
                        {
                            b1.Property<int>("MovieIdentifier")
                                .HasColumnType("int");
